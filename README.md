...
![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=cvbret&theme=github)
...
- Computer Science student  | 计算机专业学生
- Comfortable with C/C++, Python, and Java  | 熟悉 C/C++、Python 以及Java  
- I like building tools, optimizing workflows, and automating repetitive tasks | 喜欢开发工具、优化流程，并用自动化减少重复工作 
- I'm more inclined toward application development and open-source project collaboration. | 倾向于做应用和开源项目协作
...
## 💡 Collaboration Interests | 感兴趣的领域
